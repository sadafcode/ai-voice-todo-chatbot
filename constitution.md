...
- [x] MCP tools for task operations
- [x] OpenAI Agents integration
- [x] Conversational interface
- [x] Context-aware responses
- [x] Stateless chat with persistent state
- [x] Voice input with speech recognition (English/Urdu)
- [x] Automatic language detection
- [x] Bilingual UI support (English ↔ Urdu with RTL)
...
- **Voice Commands for Chatbot**: Frontend-only voice input capability using Web Speech API located at .claude/skills/voice-commands-chatbot.md
- **Usage**: Enable voice-based interaction for AI chatbot with automatic language detection (English/Urdu)
- **Activation**: Triggered when user mentions voice, microphone, speech recognition, or hands-free interaction
- **Capabilities**: Real-time transcription, auto-send, bilingual UI, graceful browser fallback, zero backend changes
- **Browser Support**: Chrome, Edge, Opera (full support); Firefox (feature hidden); Safari (limited English-only support)